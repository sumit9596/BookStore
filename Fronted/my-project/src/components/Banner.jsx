        ...
        <>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-12 m-4 md:m-12 mt-20 md:mt-24 relative overflow-hidden'>
                ...
                <div className='order-2 md:order-1 relative z-10'>
                    <div className='bg-white/5 dark:bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-white/10 dark:border-gray-700/50'>
                        ...
                        <div className='mx-2 md:mx-6 my-5 flex flex-col sm:flex-row gap-3'>
                            <div className='flex items-center gap-2 w-full sm:w-auto bg-white/10 dark:bg-gray-700/30 border border-white/20 dark:border-gray-600/50 rounded-lg px-4 py-2 focus-within:border-pink-500 transition-colors'>
                                <svg className="h-5 w-5 opacity-70 text-gray-400 dark:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <g
                                ...
                                <input type="email" placeholder="Enter your email for updates" className="flex-1 bg-transparent outline-none text-white dark:text-gray-300 placeholder-gray-400 dark:placeholder-gray-500" />
                            </div>
                        </div>
                        <div className='mx-2 md:mx-6 my-5 flex flex-col sm:flex-row gap-4'>
                            ...
                            <button className="w-full sm:w-auto px-6 py-3 border-2 border-white/30 dark:border-gray-600 text-white font-semibold rounded-lg hover:border-pink-500 hover:bg-pink-500/10 dark:hover:border-pink-400/50 dark:hover:bg-pink-500/10 transition-all duration-300 cursor-pointer">
                                Join Community
                            </button>
                        </div>
                    </div>
